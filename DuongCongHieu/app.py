...
cred = credentials.Certificate("./iuh-20005201-c6660-firebase-adminsdk-e6q8v-d8f9173763.json")
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20005201').stream())
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H4(
                    "Trường: IUH, Lớp: DHHTTT16A, MSSV: 20005021, Tên: Dương Công Hiếu", className="header-title"
                )
            ],
            className="header",
        ),
